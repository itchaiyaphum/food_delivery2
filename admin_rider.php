...
// ดึงข้อมูลผู้ส่งอาหารเฉพาะ id นั้นๆ
...
<main>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                for ($i = 0; $i < count($items); ++$i) {
                                    $row = $items[$i];
                                    $approve_link = "/admin_rider.php?action=approve&id={$row['id']}";
    ...
    ?>
                        ...
                        for ($i = 0; $i < count($items); ++$i) {
                            $row = $items[$i];
                            $cancel_link = "/admin_rider.php?action=cancel&id={$row['id']}";
