...
// ดึงข้อมูลจาก food_menu ใน database ขึ้นมาทั้งหมด
function func_items()
{
    
    $where = get_query_where();
    $sql = "SELECT * FROM `food_menu` WHERE {$where}";
    $items = db_get($sql);

    return $items;
}

// ดึงข้อมูลจาก food_menu ใน database ขึ้นมาเฉพาะ id นั้นๆ
...
// เพิ่ม/แก้ไข ข้อมูล food_menu ใน database
function func_save($form_data = null)
{
    ...
    if ($form_data['id'] == 0) {
        ...
        return db_insert('food_menu', $data);
    }
    // หากไม่ใช่ ก็คือการ อัพเดต
        ...
        return db_update('food_menu', $data, $where);
    }
}
...
function func_delete($id = 0)
{
    ...
    return db_delete('food_menu', $where);
}
?>
...
function controller_edit()
{
    ...
    validation_set_rules('title', 'เมนูอาหาร', 'required');

    // run validation
    if (validation_run()) {
        func_save($form_data);
        redirect('/restaurant_food_menu.php');
    }
}
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-7 mb-2">
                                    <div class="d-flex justify-content-end">
                                        <a href="/restaurant_food_menu.php?action=edit&id=0"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                for ($i = 0; $i < count($items); ++$i) {
                                    $row = $items[$i];
                                    $edit_link = "/restaurant_food_menu.php?action=edit&id={$row['id']}";
                                    $delete_link = "/restaurant_food_menu.php?action=delete&id={$row['id']}";
                                    ?>
                                <div class="col-4">
                                    <div class="card mb-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <form id="adminForm" method="post" enctype="multipart/form-data">
                    <div class="page-header mt-3">
                        <div class="d-flex justify-content-between">
                            <h1>จัดการเมนูอาหาร [เพิ่ม/แก้ไข]</h1>
                            <div>
                    ...
                    <div class="card mb-5">
                        <div class="card-body">
                            ...
                            <!-- field: title -->
                            <div class="row mb-4">
                                <label for="titleLabel" class="col-sm-3 col-form-label form-label">เมนูอาหาร *
                                </label>
                                <div class="col-sm-9">
