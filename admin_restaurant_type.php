...
function func_save($form_data = null)
{
    ...
    if (isset($_FILES['thumbnail'])) {
        ...
        $thumbnail_data = upload_file('thumbnail', $upload_config);
    ...
    if ($form_data['id'] == 0) {
        ...
        return db_insert('restaurant_type', $data);
    }
    // หากไม่ใช่ ก็คือการ อัพเดต
        ...
        return db_update('restaurant_type', $data, $where);
    }
}
...
function func_delete($id = 0)
{
    ...
    return db_delete('restaurant_type', $where);
}
?>
...
function controller_edit()
{
    ...
    validation_set_rules('title', 'ประเภทร้านอาหาร', 'required');
